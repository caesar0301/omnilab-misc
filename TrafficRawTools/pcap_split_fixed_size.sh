#! /usr/bin/env bash
# pcapsplit.sh: dependent on tcpdump
#
# A preprocessing tool for hadoop to prepare fixed-size input pcap files.s
#
# A wrapper of tcpdump to split a large trace into multiple small subtraces,
# supporting to processe a single pcap file and all files under a folder.
#
