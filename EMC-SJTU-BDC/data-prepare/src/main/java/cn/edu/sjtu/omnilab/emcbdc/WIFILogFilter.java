        ...
        if (hasCodes(messageCode, CODE_AUTHREQ)) { // Auth request
            ...
            if (matcher.find()) {
                ...
                cleanLog = String.format("%s,%s,%s,%s",
                        usermac, time, WIFICode.AuthRequest, matcher.group("apname"));
            }
            ...
            if (matcher.find()) {
                ...
                String time = formattrans(matcher.group("time"));
                cleanLog = String.format("%s,%s,%s,%s",
                        usermac, time, WIFICode.Deauth, matcher.group("apname"));
            }
            ...
            if (matcher.find()) {
                ...
                String time = formattrans(matcher.group("time"));
                cleanLog = String.format("%s,%s,%s,%s",
                        usermac, time, WIFICode.AssocRequest, matcher.group("apname"));
            }
            ...
            if (matcher.find()) {
                ...
                String time = formattrans(matcher.group("time"));
                cleanLog = String.format("%s,%s,%s,%s",
                        usermac, time, WIFICode.Disassoc, matcher.group("apname"));
            }
            ...
            if (matcher.find()) {
                ...
                cleanLog = String.format("%s,%s,%s,%s,%s,%s", usermac, time, WIFICode.UserAuth,
                        matcher.group("apname"), matcher.group("username"), matcher.group("userip"));
            }
